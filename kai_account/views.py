    ...
    if request.method == 'POST':
        ...
        if form_type == 'form1': 
            ...
            if form.is_valid():  
                ...
                form.save()
                return redirect('kai_account:profile')
            
    return render(request, 'kai/edit-profile.html', {'form': form , 'user' : user})
...
def changepassword_view(request):
    ...
    return render(request, 'kai/change-password.html', {'user': user, 'form': form})
