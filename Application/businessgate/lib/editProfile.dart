...
class _EditProfileState extends State<EditProfile> {
  ...
  nameField(Size size, BuildContext context) {
    return TextFormField(controller: nameController,
  ...
  emailField(Size size, BuildContext context) {
    return TextFormField(controller: lastNameController,
    cursorColor: Colors.white,
    style: TextStyle(color: Colors.white.withOpacity(0.9)),
    decoration: InputDecoration(
      focusedBorder: OutlineInputBorder(
  ...
  phoneField(Size size, BuildContext context) {
    return TextFormField(controller: phoneController,
    cursorColor: Colors.white,
    style: TextStyle(color: Colors.white.withOpacity(0.9)),
    decoration: InputDecoration(
      focusedBorder: OutlineInputBorder(
  ...
  TextFormField passField (String text, IconData icon,  
