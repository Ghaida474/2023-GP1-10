# Generated by Django 4.0.5 on 2024-03-25 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True)),
                ('new_user', models.BooleanField(blank=True, null=True)),
                ('id_departmenthead', models.BooleanField(default=False)),
                ('sendnotificationbyemail', models.BooleanField(db_column='sendnotificationbyemail', default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_target', models.ForeignKey(db_column='faculty_target_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.facultystaff')),
