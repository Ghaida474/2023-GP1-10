    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataofbuproposal', models.DateField(blank=True, db_column='dataOfBuProposal', null=True)),
                ('dataofbuacceptance', models.DateField(blank=True, db_column='dataOfBuAcceptance', null=True)),
                ('dataofburejection', models.DateField(blank=True, db_column='dataOfBuRejection', null=True)),
                ('dataofkaiacceptance', models.DateField(blank=True, db_column='dataOfKaiAcceptance', null=True)),
                ('dataoffacultyacceptance', models.DateField(blank=True, db_column='dataOfFacultyAcceptance', null=True)),
                ('dataofkairejection', models.DateField(blank=True, db_column='dataOfKaiRejection', null=True)),
                ('dataoffacultyrejection', models.DateField(blank=True, db_column='dataOfFacultyRejection', null=True)),
