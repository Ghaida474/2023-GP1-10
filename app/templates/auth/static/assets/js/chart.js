$(function() {
	...
	gradient.addColorStop(1, '#fe7f00');
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
	...
	gradient1.addColorStop(0, 'rgba(71, 84, 242,0)');
	gradient1.addColorStop(1, 'rgba(71, 84, 242,.5)');
	var gradient2 = ctx3.createLinearGradient(0, 280, 0, 0);
	gradient2.addColorStop(0, 'rgba(240, 74, 32, 0)');
	gradient2.addColorStop(1, 'rgba(240, 74, 32, .5)');
	new Chart(ctx9, {
		type: 'line',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
